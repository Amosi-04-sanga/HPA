...
const About = () => {
  return (
    <div id='about' className='px-8 mt-16 flex flex-wrap md:justify-center gap-12'>
        ...
        <p className="py-4 mt-4">The establishment of Networking for Healthcare Promotion (HPA) arises from the need to address significant challenges facing the Tanzanian healthcare sector, including disparities in healthcare access, inadequate health infrastructure, and gaps in health promotion and disease prevention.</p>
